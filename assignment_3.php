...
// tables together.
$query_result = $mysql_connection->query("SELECT customerName, country, firstName, lastName FROM customers, employees WHERE customers.salesRepEmployeeNumber = employees.employeeNumber ORDER BY country, customerName");
